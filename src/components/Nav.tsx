...
export default function Nav() {
  return (
    <nav class="flex justify-between font-semibold bg-gradient-to-r from-primary to-accent text-primary-content p-5 gap-3">
      <ul class="flex gap-3">

        <li class="px-5 whitespace-nowrap font-bold text-xl">
          <A href="/">
            My Website
          </A>
        </li>
